...
namespace CurzCoin
{
    class Blockchain
    {
        ...
        {
            return new Block(0, DateTime.Now.ToString("yyyyMMHHmmssffff"), new List<Transaction>());
        }
        ...
        public void addPendingTransaction(Transaction transaction)
        {
            ...
            {
                throw new Exception("There must be suffivient money in the wallet");
            }
        ...
        public void MinePendingTransactions(PublicKey miningRewardWallet)
        {
            ...
            Block newBlock = new Block(GetLastestBlock().Index + 1, DateTime.Now.ToString("yyyyMMHHmmssffff"), this.pendingTransactions, GetLastestBlock().Hash);
